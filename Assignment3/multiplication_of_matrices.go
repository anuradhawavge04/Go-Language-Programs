...
func main() {
	...
	fmt.Print("Enter the number of rows of the first matrix:")
	fmt.Scanln(&m)

	fmt.Println("Enter the number of columns of the first matrix:")
	fmt.Scanln(&n)

	fmt.Print("Enter the number of rows of the second matrix:")
	fmt.Scanln(&p)

	fmt.Print("Enter the number of columns of second matrix:")
	fmt.Scanln(&q)
